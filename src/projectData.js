const projectData = 
  [{
      type: 'Website',
      name: 'Sure Hope Foundation',
      logo: 'images/surehopelogo.jpg',
      logoAlt: 'Sure Hope Foundation Logo',
      image: 'images/surehope2_resized.jpg',
      imageAlt: 'Sure Hope Foundation Thumbnail',
      company: 'Freelance',
  ...
  },
  {
    type: 'Web App',
    name: 'Firestack',
    logo: 'images/firestacklogo.jpg',
    logoAlt: 'Firestack Logo',
    image: 'images/firestack2_resized.jpg',
    imageAlt: 'Firestack Thumbnail',
    company: 'Liberty Mutual Insurance - Software Engineer Intern',
    location: 'Seattle, WA',
    jobRole: 'Team Lead - Full Stack Developer',
  ...
  },
  {
    ...
    logo: 'images/shinylogo.jpg',
    logoAlt: 'Shiny Key Realty Logo',
    image: 'images/shinykeyrealty.png',
    imageAlt: 'Shiny Key Realty Thumbnail',
    company: 'Freelance',
...
},
{
  ...
  imageAlt: 'Moore and Cross Thumbnail',
  company: 'Freelance',
  ...
  to provide excellent service to their clients. The website's main goal is to provide
  insight of their services and attract new customers.`
},
{
  type: 'Website/Web App',
  name: 'Shiny Key Realty',
  ...
  imageAlt: 'Balance Youth Sports Thumbnail',
  company: 'Freelance',
  location: 'Madison, WI',
